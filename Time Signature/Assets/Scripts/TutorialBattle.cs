...
public enum TutorialBattleState { START, PLAYERTURN, ENEMYTURN, DIALOGUE, WON, LOST }
...
public class TutorialBattle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        state = TutorialBattleState.START;
    ...
    IEnumerator SetUp()
    {
        ...
        if (EnemyEncounter.enemyName == null)
        {
            EnemyEncounter.enemyName = "Slime (UnityEngine.GameObject)";
        }
    ...
    IEnumerator EnemyTurn()
    {
        ...
        if(isDead)
        {
            state = TutorialBattleState.LOST;
